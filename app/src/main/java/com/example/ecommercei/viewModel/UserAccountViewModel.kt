...
import com.example.FaramawyApplication
...
class UserAccountViewModel @Inject constructor(
    ...
    fun updateUserInfo(user: User,imageUri: Uri?){
        val areInputsVaild = validationEmail(user.email) is RegisterValidation.Success
        ...
        viewModelScope.launch {
            try {
                val imgBitmap = MediaStore.Images.Media.getBitmap(
                    getApplication<FaramawyApplication>().contentResolver ,imageUri
                )
